...
///// <summary>
///// loading the fragment shader from txt file
///// </summary>
///// <returns></returns>
//std::string Game::loadFragmentShaderFile()
//{
//	std::ifstream myReadFile;
//	std::string string;
//	myReadFile.open("FragmentShader.txt");
//	while (!myReadFile.eof()) // To get you all the lines.
//	{
//		getline(myReadFile, string); // Saves the line in STRING.
//		fileContentsFragment.append(string + "\n"); // Prints our STRING.
//	}
//	myReadFile.close();
//	std::cout << fileContentsFragment;
